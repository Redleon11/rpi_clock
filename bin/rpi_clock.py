...
def display_main_procedure():
    ...
    if flag_display_normal:
        ...
        display_cur_cond.config(text="%s, %d %s" % (str_condition,str_temp,parms.TEMP_SUFFIX))
    else:
...
display_spacer_mid = Label(tk_root, font=(FONT_NAME, 25, FONT_STYLE), \
                        fg=FG_COLOR_NORMAL, bg=BG_COLOR_ROOT)
display_spacer_mid.pack()
display_spacer_mid.config(text=" ")

display_date = Label(tk_root, font=(FONT_NAME, 30, FONT_STYLE), \
                     fg=FG_COLOR_NORMAL, bg=BG_COLOR_ROOT)
display_date.pack()

display_spacer_cond = Label(tk_root, font=(FONT_NAME, 75, FONT_STYLE), \
                        fg=FG_COLOR_NORMAL, bg=BG_COLOR_ROOT)
...
display_spacer2 = Label(tk_root, font=(FONT_NAME, 40, FONT_STYLE), \
                        fg=FG_COLOR_NORMAL, bg=BG_COLOR_ROOT)
